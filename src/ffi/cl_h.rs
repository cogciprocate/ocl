...
extern "system" {
    ...
    pub fn clSetMemObjectDestructorCallback(memobj: cl_mem,
                                            pfn_notify: Option<extern "C" fn(cl_mem, *mut c_void)>,
                                            user_data: *mut c_void)
                                            -> cl_int;
    ...
    pub fn clSetEventCallback(event: cl_event,
                              ...
                              pfn_notify: Option<extern "C" fn(cl_event, cl_int, *mut c_void)>,
                              user_data: *mut c_void)
                              -> cl_int;
    ...
    // ################## NEW 1.2 ###################
    pub fn clEnqueueBarrierWithWaitList(command_queue: cl_command_queue,
                                        num_events_in_wait_list: cl_uint,
                                        event_wait_list: *const cl_event,
                                        event: *mut cl_event)
                                        -> cl_int;
    ...
    //                    ) CL_API_SUFFIX__VERSION_1_2;
    // ################## NEW 1.2 ###################
    pub fn clGetExtensionFunctionAddressForPlatform(platform: cl_platform_id, func_name: *const c_char) -> *mut c_void;
}
