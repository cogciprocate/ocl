...
pub use self::cl::abs::{EventRawNew, PlatformIdRaw, DeviceIdRaw, ContextRaw, CommandQueueRaw, MemRaw, 
	ProgramRaw, KernelRaw, /*EventPtr,*/ EventRaw, EventListRaw, SamplerRaw};
