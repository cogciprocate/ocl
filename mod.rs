...
pub use self::functions::{ get_platform_ids, get_platform_info,
    ...
    create_from_gl_buffer, create_from_gl_renderbuffer, create_from_gl_texture_2d,
    create_from_gl_texture_3d, enqueue_acquire_gl_buffer, enqueue_release_gl_buffer,
    enqueue_fill_buffer,
