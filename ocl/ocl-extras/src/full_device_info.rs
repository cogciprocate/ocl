use ocl::core::{DeviceId, DeviceInfo, DeviceInfoResult, OpenclVersion, PlatformId};
use ocl::enums::{DeviceLocalMemType, DeviceMemCacheType, DevicePartitionProperty};
use ocl::error::Result as OclResult;
use ocl::flags::{DeviceAffinityDomain, DeviceExecCapabilities, DeviceFpConfig};
use ocl::{CommandQueueProperties, Device, DeviceType};
